...
class Ui_DVW_Widget(object):
    def setupUi(self, DVW_Widget):
        ...
        DVW_Widget.resize(1175, 717)
        self.gridLayout = QtWidgets.QGridLayout(DVW_Widget)
        self.gridLayout.setObjectName("gridLayout")
        self.downloadProgress_TW = TableWidget(DVW_Widget)
        ...
        self.gridLayout.addWidget(self.downloadProgress_TW, 1, 0, 1, 4)
        ...
        self.downloadStatus_TW.setMinimumSize(QtCore.QSize(700, 0))
        ...
        self.gridLayout.addWidget(self.downloadStatus_TW, 1, 4, 1, 1)
