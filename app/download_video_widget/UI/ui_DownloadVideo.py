...
class Ui_DVW_Widget(object):
    def setupUi(self, DVW_Widget):
        ...
        sizePolicy.setHeightForWidth(
            self.startDownLoad_PB.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.reDownload_PB.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(2)
        sizePolicy.setHeightForWidth(
            self.downloadError_TW.sizePolicy().hasHeightForWidth()
        )
        self.downloadError_TW.setSizePolicy(sizePolicy)
        self.downloadError_TW.setEditTriggers(
            QtWidgets.QAbstractItemView.NoEditTriggers
        )
        ...
        self.fileCount_TW.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.downloadStatus_TL.sizePolicy().hasHeightForWidth()
        )
        ...
        self.downloadStatus_TW.setEditTriggers(
            QtWidgets.QAbstractItemView.NoEditTriggers
        )
        ...
        spacerItem3 = QtWidgets.QSpacerItem(
            44, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum
        )
    ...
    def retranslateUi(self, DVW_Widget):
        ...
        self.TitleLabel.setText(_translate("DVW_Widget", "下载错误/缺失文件"))
        ...
        item.setText(_translate("DVW_Widget", "缺失文件数量"))
