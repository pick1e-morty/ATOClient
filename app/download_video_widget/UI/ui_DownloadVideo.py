...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(1075, 882)
        self.startDownLoad_PB = PushButton(Form)
        ...
        self.downLoadStatus_TW = TableWidget(Form)
    ...
    def retranslateUi(self, Form):
        ...
        self.startDownLoad_PB.setText(_translate("Form", "开始下载"))
        self.TitleLabel.setText(_translate("Form", "下载状态"))
        ...
        item.setText(_translate("Form", "月台"))
