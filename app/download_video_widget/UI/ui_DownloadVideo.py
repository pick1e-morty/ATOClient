...
class Ui_DVW_Widget(object):
    def setupUi(self, DVW_Widget):
        ...
        self.downloadProgress_TW.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        ...
        self.downloadError_TW.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        ...
        self.downloadStatus_TW.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
