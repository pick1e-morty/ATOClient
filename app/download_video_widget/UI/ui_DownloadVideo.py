...
class Ui_DVW_Widget(object):
    def setupUi(self, DVW_Widget):
        ...
        self.gridLayout_4.addWidget(self.fileCount_TW, 1, 0, 1, 3)
        ...
        self.argsCount_TL_2 = TitleLabel(self.CardWidget_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.argsCount_TL_2.sizePolicy().hasHeightForWidth())
        self.argsCount_TL_2.setSizePolicy(sizePolicy)
        self.argsCount_TL_2.setObjectName("argsCount_TL_2")
        self.gridLayout.addWidget(self.argsCount_TL_2, 0, 0, 1, 1)
    ...
    def retranslateUi(self, DVW_Widget):
        ...
        self.argsCount_TL.setText(_translate("DVW_Widget", "下载进度"))
        ...
        self.argsCount_TL_2.setText(_translate("DVW_Widget", "详细下载状态"))
