...
class Ui_EPW_Widget(object):
    def setupUi(self, EPW_Widget):
        ...
        self.splitter = QtWidgets.QSplitter(EPW_Widget)
        ...
        self.excelFile_LW.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        ...
        self.excelData_TW = CustomTableWidget(self.CardWidget_3)
        self.excelData_TW.setMinimumSize(QtCore.QSize(419, 0))
        self.excelData_TW.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        ...
        self.sameYTCount_TW = CustomTableWidget(self.CardWidget_4)
        self.sameYTCount_TW.setMinimumSize(QtCore.QSize(336, 0))
        self.sameYTCount_TW.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
    ...
    def retranslateUi(self, EPW_Widget):
        ...
        item.setText(_translate("EPW_Widget", "9"))
