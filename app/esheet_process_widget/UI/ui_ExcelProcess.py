...
# Form implementation generated from reading ui file 'C:\Users\Hast\Documents\CodeProjects\Python\ATOClient\app\esheet_process_widget\UI\ExcelProcess.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_2.addWidget(self.shipCID_LE, 1, 1, 1, 2)
        self.scanTimeCID_LE = LineEdit(self.CardWidget_2)
        self.scanTimeCID_LE.setReadOnly(True)
        self.scanTimeCID_LE.setObjectName("scanTimeCID_LE")
        self.gridLayout_2.addWidget(self.scanTimeCID_LE, 3, 1, 1, 2)
        ...
        self.scanTimeFormat_LE = LineEdit(self.CardWidget_2)
        self.scanTimeFormat_LE.setReadOnly(True)
        self.scanTimeFormat_LE.setObjectName("scanTimeFormat_LE")
        self.gridLayout_2.addWidget(self.scanTimeFormat_LE, 7, 0, 1, 3)
        self.BodyLabel_6 = BodyLabel(self.CardWidget_2)
        self.BodyLabel_6.setAlignment(QtCore.Qt.AlignCenter)
        self.BodyLabel_6.setObjectName("BodyLabel_6")
        self.gridLayout_2.addWidget(self.BodyLabel_6, 6, 0, 1, 3)
        self.BodyLabel_2 = BodyLabel(self.CardWidget_2)
        self.BodyLabel_2.setObjectName("BodyLabel_2")
        self.gridLayout_2.addWidget(self.BodyLabel_2, 3, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.ytCID_LE, 2, 1, 1, 2)
        ...
        # self.ui.excelData_TW = QTableWidget()
        ...
        self.flowLayout_1 = QtWidgets.QWidget(self.shipGB)
        self.flowLayout_1.setObjectName("flowLayout_1")
        self.gridLayout_8 = QtWidgets.QGridLayout(self.flowLayout_1)
        self.gridLayout_8.setObjectName("gridLayout_8")
        self.selectAllShipID_PB = PushButton(self.flowLayout_1)
        self.selectAllShipID_PB.setObjectName("selectAllShipID_PB")
        self.gridLayout_8.addWidget(self.selectAllShipID_PB, 0, 0, 1, 1)
        self.reverseSelectionShipID_PB = PushButton(self.flowLayout_1)
        self.reverseSelectionShipID_PB.setObjectName("reverseSelectionShipID_PB")
        self.gridLayout_8.addWidget(self.reverseSelectionShipID_PB, 1, 0, 1, 1)
        self.deleteSelectionShipID_PB = PushButton(self.flowLayout_1)
        self.deleteSelectionShipID_PB.setObjectName("deleteSelectionShipID_PB")
        self.gridLayout_8.addWidget(self.deleteSelectionShipID_PB, 2, 0, 1, 1)
        self.verticalLayout.addWidget(self.flowLayout_1)
        ...
        self.keepShipNum_SPB = SplitPushButton(self.ytGB)
        self.keepShipNum_SPB.setObjectName("keepShipNum_SPB")
        self.horizontalLayout.addWidget(self.keepShipNum_SPB)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem)
        self.verticalLayout_2.addLayout(self.horizontalLayout)
        self.flowLayout_2 = QtWidgets.QWidget(self.ytGB)
        self.flowLayout_2.setObjectName("flowLayout_2")
        self.gridLayout_7 = QtWidgets.QGridLayout(self.flowLayout_2)
        self.gridLayout_7.setObjectName("gridLayout_7")
        self.selectAllYT_PB = PushButton(self.flowLayout_2)
        self.selectAllYT_PB.setObjectName("selectAllYT_PB")
        self.gridLayout_7.addWidget(self.selectAllYT_PB, 0, 0, 1, 1)
        self.reverseSelectionYT_PB = PushButton(self.flowLayout_2)
        self.reverseSelectionYT_PB.setObjectName("reverseSelectionYT_PB")
        self.gridLayout_7.addWidget(self.reverseSelectionYT_PB, 1, 0, 1, 1)
        self.deleteSelectionYT_PB = PushButton(self.flowLayout_2)
        self.deleteSelectionYT_PB.setObjectName("deleteSelectionYT_PB")
        self.gridLayout_7.addWidget(self.deleteSelectionYT_PB, 2, 0, 1, 1)
        self.verticalLayout_2.addWidget(self.flowLayout_2)
    ...
    def retranslateUi(self, Form):
        ...
        self.newFormat_RB.setText(_translate("Form", "常用格式"))
        ...
        self.oldFormat_RB.setText(_translate("Form", "其他格式"))
        self.scanTimeFormat_LE.setText(_translate("Form", "%Y-%m-%d %H:%M:%S"))
        self.BodyLabel_6.setText(_translate("Form", "扫描时间格式"))
...
from qfluentwidgets import BodyLabel, CardWidget, LineEdit, ListWidget, PushButton, RadioButton, SplitPushButton, TableWidget, TitleLabel
